...
Question.create(query: "What is the closest planet to the Sun?", answer: "Mercury", incorrect1: "Earth", incorrect2: "Neptune", incorrect3: "Venus", hint: "It's also inside a thermometer", solar_object_id: 2)
Question.create(query: "What is the hottest planet in our Soalr System?", answer: "Mercury", incorrect1: "Jupiter", incorrect2: "Saturn", incorrect3: "Venus", hint: "It's hot next to the fire", solar_object_id: 2)
Question.create(query: "What is the smallest planet in our Solar System?", answer: "Mercury", incorrect1: "Earth", incorrect2: "Mars", incorrect3: "Venus", hint: "It's also inside a thermometer", solar_object_id: 2)